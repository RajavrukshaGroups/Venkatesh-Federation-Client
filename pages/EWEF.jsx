...
import { Users, Zap, Target, ArrowRight, Globe, Smartphone, Landmark, Star, Rocket, Award, Heart } from 'lucide-react';
  ...
  return (
    <div className="bg-white font-sans">
      ...
      <section className="relative w-full overflow-hidden bg-[#FFF8E1] min-h-[85vh] flex flex-col items-center pt-12 pb-0 border-x-[12px] border-b-[12px] border-[#DC2626] box-border border-t-0">
        ...
        <div className="absolute top-8 right-8 z-30 hidden md:block">
            <div className="bg-pink-50/90 px-6 py-4 rounded-xl shadow-lg border border-pink-200 flex flex-col items-center justify-center backdrop-blur-sm">
                 <div className="text-4xl font-thin text-slate-800 tracking-[0.2em] mb-1">EWEF</div>
                 <div className="h-px w-full bg-pink-400 mb-1"></div>
                 <span className="text-[10px] text-slate-600 font-bold uppercase tracking-widest text-center">Emerging Women<br/>Entrepreneur Forum</span>
            </div>
        </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle title="Empowering Women in Business" subtitle="Leading with resilience, innovation, and vision." />
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
           <div className="prose prose-lg text-slate-600 text-justify">
               <p className="mb-4">
                  The <strong>Emerging Women Entrepreneurs Forum (EWEF)</strong> is a pivotal wing of FTII, dedicated to nurturing and empowering women entrepreneurs across India. We believe that economic independence for women is the cornerstone of a developed nation.
               </p>
               <p className="mb-4">
                  EWEF focuses on policy advocacy for women-led businesses, easing access to capital, and providing specialized mentorship programs. We bridge the gap between aspiring women entrepreneurs and established industry leaders.
               </p>
               <p className="mb-4">
                  From navigating government schemes to digital literacy workshops, EWEF provides a comprehensive support system. We celebrate the achievements of women who have broken glass ceilings and are paving the way for future generations.
               </p>

               <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="bg-pink-50 p-4 border-l-4 border-pink-600 rounded hover:shadow-md transition-shadow">
                      <span className="block text-3xl font-bold text-pink-900 mb-1">30%</span>
                      <span className="text-sm text-pink-800 uppercase font-bold">Women in Biz</span>
                  </div>
                  <div className="bg-purple-50 p-4 border-l-4 border-purple-600 rounded hover:shadow-md transition-shadow">
                      <span className="block text-3xl font-bold text-purple-900 mb-1">Global</span>
                      <span className="text-xs text-purple-800 uppercase font-bold">Network Access</span>
                  </div>
               </div>
           </div>
           ...
           <div className="space-y-8 sticky top-24">
               <div className="relative h-80 rounded-2xl overflow-hidden shadow-2xl group">
                  <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Women Network" />
                  <div className="absolute inset-0 bg-gradient-to-t from-pink-900/80 to-transparent flex items-end p-8">
                      <p className="text-white font-bold text-xl leading-snug">"When women succeed, nations prosper."</p>
                  </div>
               </div>
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-pink-500 hover:-translate-y-2 transition-transform">
                ...
                <h3 className="text-xl font-bold text-navy-900 mb-2">Mentorship Programs</h3>
                <p className="text-slate-600">Connecting aspiring entrepreneurs with seasoned women leaders for guidance.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-purple-500 hover:-translate-y-2 transition-transform">
                ...
                <h3 className="text-xl font-bold text-navy-900 mb-2">Awards & Recognition</h3>
                <p className="text-slate-600">Annual awards celebrating excellence in women-led enterprises.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-orange-500 hover:-translate-y-2 transition-transform">
                ...
                <h3 className="text-xl font-bold text-navy-900 mb-2">Global Trade</h3>
                <p className="text-slate-600">Facilitating participation in international trade fairs and delegations.</p>
            </div>
        </div>
      </section>
    </div>
