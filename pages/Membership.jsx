...
const Membership = () => {
  ...
  const fetchMembershipPlans = async () => {
    try {
      ...
      else setError("Failed to load membership plans");
    } catch (err) {
  ...
  const membershipBenefits = [
    { icon: Shield, title: "Policy Advocacy", description: "Representation in government policy discussions", color: "text-blue-700", bgColor: "bg-blue-50" },
    { icon: Users, title: "Networking", description: "Connect with industry leaders and peers", color: "text-red-600", bgColor: "bg-red-50" },
    { icon: Award, title: "Recognition", description: "Industry awards and recognition programs", color: "text-green-700", bgColor: "bg-green-50" },
    { icon: TrendingUp, title: "Growth", description: "Business growth opportunities and support", color: "text-purple-700", bgColor: "bg-purple-50" },
    { icon: Globe, title: "Global Access", description: "International trade opportunities", color: "text-amber-700", bgColor: "bg-amber-50" },
    { icon: Zap, title: "Digital Tools", description: "Access to business tools and resources", color: "text-cyan-700", bgColor: "bg-cyan-50" },
  ];
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <motion.section
        ...
        initial="hidden"
        animate="visible"
        className="relative py-16 md:py-24 bg-gradient-to-b from-[#fff4cc] via-[#fff1bf] to-[#ffedb3]"
      >
        <div className="max-w-6xl mx-auto px-4 text-center">
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="text-3xl sm:text-4xl md:text-6xl font-bold text-[#5D2E18] mb-4"
          >
            Membership Plans <br className="hidden md:block" />
            Grow With AITIF
          </motion.h1>
          ...
          >
            Choose the membership plan that best fits your business needs and unlock exclusive benefits.
          </motion.p>
          ...
          >
            <Link
              to="/membership-registration"
              className="inline-flex items-center gap-2 px-6 py-3 bg-blue-700 text-white font-bold rounded-lg hover:bg-blue-800 transition"
            >
              Registration Form
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 md:-mt-16 relative z-20">
              ...
              <div className="p-6">
                <ul className="space-y-3">
                  {plan.benefits.map((benefit) => (
                    <li key={benefit._id} className="flex items-start gap-3">
                ...
                <Link to="/membership-registration">
                  <button className="w-full mt-6 py-3 rounded-lg bg-blue-700 text-white font-bold hover:bg-blue-800 transition">
                    Select This Plan
                  </button>
                </Link>
              </div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="bg-gradient-to-r from-blue-50 to-red-50 rounded-2xl p-8 mb-16"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {["Select Plan", "Fill Form", "Make Payment", "Get Access"].map(
              (step, i) => (
