...
import { Users, Briefcase, Zap, Award, CheckCircle, Landmark, Mail, MapPin, Facebook, Twitter, Linkedin, Instagram, Youtube, ArrowRight, Globe, Smartphone, Star, Rocket } from 'lucide-react';
            ...
            <div className="lg:w-7/12">
               <div className="mb-8">
                  <div className="flex items-center space-x-2 mb-3">
                     ...
                     <span className="text-gold-600 font-bold tracking-widest uppercase text-xs">Who We Are</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-serif font-bold text-navy-900 mb-6 leading-tight">Welcome to <span className="text-blue-700">FTII</span></h2>
                  <p className="text-lg font-medium text-slate-500">The Premier Voice of India's Trade & Industry</p>
               </div>
               ...
               <div className="prose prose-lg text-slate-600 text-justify leading-relaxed">
                  <p className="text-xl font-medium text-navy-900 mb-6 border-l-4 border-gold-500 pl-6 py-2 italic bg-gray-50 rounded-r-lg">
                     "Our mission is to promote economic growth, job creation, and entrepreneurship in the country."
                  </p>
                  <p className="mb-6">
                     At FTII, we understand the challenges faced by businesses in today’s rapidly changing economy.
                  </p>
                  <div className="flex flex-wrap gap-4 mt-10">
                    <Link to="/membership" className="bg-navy-900 text-white px-8 py-4 rounded shadow-lg hover:bg-blue-800 transition-all flex items-center gap-2 group">
                       <Briefcase size={18} />
