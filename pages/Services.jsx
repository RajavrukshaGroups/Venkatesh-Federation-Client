...
const Services = () => {
  ...
  /* DATA REMAINS SAME (shortened here for clarity) */
  // keep your services and keyBenefits arrays unchanged

  return (
    <div className="bg-white min-h-screen overflow-x-hidden">

      {/* ================= HEADER ================= */}
      <section className="relative py-14 sm:py-16 md:py-24 bg-gradient-to-b from-[#fff4cc] via-[#fff1bf] to-[#ffedb3]">
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <p className="text-sm sm:text-base md:text-lg text-gray-700 max-w-3xl mx-auto">
              Empowering businesses with expert guidance and strategic support.
            </p>
      ...
      {/* ================= MAIN CONTENT ================= */}
      <div className="max-w-7xl mx-auto px-4 mt-8 sm:mt-10 md:-mt-16 relative z-20">
        ...
        >
          ...
          <p className="text-gray-700 text-sm sm:text-base md:text-lg mb-4">
            At <strong>AITIF</strong>, we provide comprehensive business support systems.
          </p>
        </motion.div>
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            {/* keep your services.map unchanged */}
          </div>
        </div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="bg-gradient-to-r from-blue-50 to-red-50 rounded-2xl p-6 sm:p-8 md:p-12 mb-12 md:mb-16"
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-8">
            How We Deliver Value
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center">
            {/* keep your 3 value cards unchanged */}
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 text-center border mb-12"
        >
          ...
          <p className="text-sm sm:text-base text-gray-700 mb-6">
            Join AITIF today and unlock growth opportunities.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/membership" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto px-8 py-3 bg-blue-700 text-white font-bold rounded-lg hover:bg-blue-800 transition">
                Become a Member
              </button>
            </Link>

            <Link to="/contact" className="w-full sm:w-auto">
              <button className="w-full sm:w-auto px-8 py-3 border-2 border-blue-700 text-blue-700 font-bold rounded-lg hover:bg-blue-50 transition">
                Contact Our Team
              </button>
            </Link>
          </div>
